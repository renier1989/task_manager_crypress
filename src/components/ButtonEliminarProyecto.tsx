...
export const ButtonEliminarProyecto = ({ id }: ButtonEliminarProyectoProps) => {
    ...
    return (
        <>
            <div data-cy="eliminar-proyecto" className="md:self-center p-2 rounded-md bg-red-600 text-white cursor-pointer font-semibold transition-all duration-300 hover:shadow-lg">
                <button
                    onClick={handleClick}
